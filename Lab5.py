...
for i in range(len(matrix_x)):
    if i < 8:
        x1 = min_x1 if matrix_of_planning[i][0] == -1 else max_x1
        x2 = min_x2 if matrix_of_planning[i][1] == -1 else max_x2
        x3 = min_x3 if matrix_of_planning[i][2] == -1 else max_x3
    else:
...
middle_x = middleValue(matrix_x, 0)
middle_y = middleValue(matrix_y, 1)
